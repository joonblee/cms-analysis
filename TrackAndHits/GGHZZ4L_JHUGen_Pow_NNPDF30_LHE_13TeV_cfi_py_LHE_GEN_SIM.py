...
# with command line options: Configuration/Generator/python/GGHZZ4L_JHUGen_Pow_NNPDF30_LHE_13TeV_cfi.py --fileout file:output_1.root --conditions auto:run2_mc -n 100 --era Run2_2016 --eventcontent FEVTDEBUG,LHE -s LHE,GEN,SIM --datatier GEN-SIM,LHE --beamspot Realistic50ns13TeVCollision
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/Generator/python/GGHZZ4L_JHUGen_Pow_NNPDF30_LHE_13TeV_cfi.py nevts:100'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:output_1.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('file:output_1_inLHE.root'),
