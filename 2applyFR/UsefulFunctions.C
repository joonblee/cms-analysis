...
double FR_template(vector<Muon> muons) {
  ...
  const int ptbinnum = 6;
  double ptbin[ptbinnum+1] = {5,10,20,30,50,70,500};
  const int ptbinnum_endcap = 6;
  double ptbin_endcap[ptbinnum_endcap+1] = {5,10,20,30,50,70,500};


  double FR_barrel[] = {0.1934,0.1236,0.1037,0.1571,0.2651,0.3083};
  double FR_endcap[] = {0.2648,0.1876,0.1448,0.1605,0.3468,0.3468};
...
double Boosted_FR_template(vector<Muon> muons) {
  ...
  double FR_barrel[] = {0.1148,0.1582,0.1766,0.2172,0.25,0.29};
  double FR_endcap[] = {0.2308,0.2616,0.2489,0.29,0.26,0.46};

  //double FR_barrel[] = {0.1148,0.1582,0.1766,0.2172,0.2126,0.217};
  //double FR_endcap[] = {0.2308,0.2616,0.2489,0.256,0.3027,0.3027};
